...
@section("content")
  <main class="main">
        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>About</h1>
              <p class="mb-0">
                A little information about me, I was previously a technician, but
                my interest in technology led me to switch careers to the field of
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i>
                    <strong>Birthday:</strong> <span>21 May 2001</span>
                  </li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong>
                    <span>0877 3526 1470</span>
                  </li>
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                    <span>ahmadjaelani8685@gmail.com</span>
                  </li>
                </ul>
              </div>
            </div>
            <p class="py-3">
              My current activities include attending evening classes at
              university. Outside of that, I spend a lot of time exploring the
              world of programming and working on projects to improve my skills.
            </p>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row skills-content skills-animation">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill"><span>HTML</span> <i
            ...
            <div class="progress">
              <span class="skill"><span>CSS</span> <i
                  class="val">90%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill"><span>React Js</span> <i
                  class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90"
                  aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <div class="progress">
              <span class="skill"><span>Kotlin</span> <i
                  class="val">50%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill"><span>PHP</span> <i
                  class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90"
                  aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <div class="progress">
              <span class="skill"><span>Laravel</span> <i
                  class="val">85%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="85"
                  aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <div class="progress">
              <span class="skill"><span>MySql</span> <i
                  class="val">85%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="85"
                  aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <div class="progress">
              <span class="skill"><span>Boostrap</span> <i
                  class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill"><span>Tailwind</span> <i
                  class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90"
                  aria-valuemin="0" aria-valuemax="100"></div>
    ...
    <section id="interests" class="interests section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Tools</h2>
        <div><span>Library</span> <span class="description-title">and
            Others</span></div>
      </div><!-- End Section Title -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Vite</a></h3>
            </div>
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            data-aos-delay="200">
            <div class="features-item">
              <i style="color: #FF2D20;">
                <svg width="28px" height="28px" role="img"
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">React Js</a>
              </h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Ant Design</a>
              </h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Material Joy Ui</a>
              </h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">React Router</a>
              </h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Redux Tookit & RTK
                  Query</a></h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Boostrap</a></h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Tailwind</a></h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Swagger</a></h3>
            </div>
          </div><!-- End Feature Item -->
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up"
            ...
            <div class="features-item">
              ...
              <h3><a href="" class="stretched-link">Figma</a>
              </h3>
            </div>
          </div><!-- End Feature Item -->
    ...
    {{-- <section id="testimonials" class="testimonials section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Blogs</h2>
        <div><span>Check my</span> <span class="description-title">Blogs</span>
        </div>
      </div><!-- End Section Title -->
